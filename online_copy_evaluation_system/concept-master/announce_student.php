...
<button type="button" class="btn btn-primary" onClick="fun()">
 Check Send announcement
  ...
  $con=mysqli_connect("localhost","root","","online_copy_evaluation");
   $sql="select anounce_id,email_id,announce,date from announce_reply_stud order by sn desc";
...
<script>
   ...
   function fun()
			{
				sscode="announce_student";
				$.ajax({
					type:'POST',
					url:'announce_stud_act2.php',
