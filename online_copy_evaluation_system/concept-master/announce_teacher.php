...
<button type="button" class="btn btn-primary" onClick="fun()">
 Check Send announcement
  ...
  $con=mysqli_connect("localhost","root","","online_copy_evaluation");
   $sql="select announce_id,email_id,announce,date from announce_reply_teach order by sn desc";
...
<script>
   ...
   function fun()
			{
				sscode="announce_teach";
				$.ajax({
					type:'POST',
					url:'announce_teach_act2.php',
