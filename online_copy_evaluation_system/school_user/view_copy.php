...
<body bgcolor="#0099FF" >
<form name ="fm6" Method="post" Action="mks.php" id="fm2" return>
  <div class="rt" id="rt"><br><center>
     ...
     <table width="253" height="150">
        ...
        <td>  
    	<input type="text" class="inco" name="res_id" id="res_id" value="<?php echo $_SESSION['sn'];?>" readonly>
        </td>
        </tr>
...
<div class="mid" id="mid">
  ...
  <?PHP 
		$con=mysqli_connect("localhost","root","","online_copy_evaluation");
		 $sh="select * from $tab where roll='$roll'";
...
?>
<img src="dataimgs/<?php echo "$tab/$roll/".$row['copy'];?>" height="600" width="750" class="img-thumbnail" id="mg">
<?php
