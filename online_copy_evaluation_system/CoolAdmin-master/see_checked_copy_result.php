...
<div class="col-md-12">
								<div class="card">
									<div class="card-header">
										...
										<strong class="card-title" v-if="headerText">See Checked Copy</strong>
				...
				<div class="modal-dialog " role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title" id="mediumModalLabel">See Checked Copy and update marks of subject:-<?php echo $sub_tech;?></h5>
